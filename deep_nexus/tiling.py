...
def TileSVS(svsFile, outdir=None, outlocaldir = None, bucket_name=None, SaveToFile = True, tile_size=512, downsample = 1,
    ...
    storage_client = storage.Client.from_service_account_json('default_deepnexus.json')
